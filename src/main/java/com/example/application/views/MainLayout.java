...
import com.example.application.views.travelfish.TravelFishView;
 ...
 */
@PWA(name = "TravelFish", shortName = "TravelFish", enableInstallPrompt = false)
...
public class MainLayout extends AppLayout {
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Home", "la la-home", TravelFishView.class), //
